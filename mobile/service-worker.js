const CACHE="proxima-acao-mobile-v7";
const ASSETS=["./","./index.html","./mobile.css","./overrides.css?v=2","./mobile.js","./manifest.webmanifest","../classic/constants.js?v=8","../classic/models.js?v=8","../classic/analytics.js?v=9","../classic/recommendation-engine.js?v=8"];
