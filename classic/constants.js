...
const AREA_LABELS = { ...AREAS, pausas: "Pausas" };
const SUBAREA_LABELS = { operacional: "Operacional", administracao: "Administração", marketing: "Marketing", desenvolvimento_empresa: "Desenvolvimento", organizacao_trabalho: "Organização de trabalho", geral: "Geral", linguas: "Línguas", piano: "Piano", livro_tecnico: "Livro técnico", concurso: "Concurso", filmes_series: "Filmes e séries", jogos: "Jogos", outro: "Outro" };
const CONTEXTS = ["computador", "celular", "internet", "telefone", "casa", "rua", "cidade", "silencio", "piano", "leitura_disponivel"];
const CONTEXT_LABELS = { computador: "Computador", celular: "Celular", internet: "Internet", telefone: "Telefone", casa: "Casa", rua: "Rua", cidade: "Cidade", silencio: "Silêncio", piano: "Piano", leitura_disponivel: "Leitura disponível" };
const ENERGY_LABELS = { 1: "Baixa", 2: "Média", 3: "Alta" };
const PRIORITY_LABELS = { normal: "Normal", alta: "Alta", critica: "Crítica" };
